package dev.gaphunter.gotimerleakcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.gotimerleakcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.gotimerleakcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Go Timer Leak Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33876-go-timer-leak-companion/reviews"
